        ...
        <tbody>
            {
                ...
                <tr>
                    <td>{img.id}</td>
                    <td><img style={{width:100}} src={img.image} alt=""/></td>
                    <td>{img.title}</td>
                    <td>{img.description}</td>
                    <td>{img.price}</td>
                    {/* <Can do="delete" on={this.img.GalleryListing}> */}
                    <td><span onClick={()=>{deleteOperation(img.id)}} className='delete'>Delete</span></td>
                    {/* </Can> */}
                    <td><Link to={"update/"+img.id}><span className='update'>Update</span></Link></td>
                </tr>
                )}
        </tbody>
        </Table>
