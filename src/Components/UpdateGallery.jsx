...
function UpdateGallery(props) {
    ...
    useEffect(async ()=>{
        let result = await fetch("https://sanaa-production.up.railway.app/art_pieces"+props.match.params.id);
  ...
  return (
    <div className='update'>
        <div className='update-gallery'>
            ...
            <img style={{width:50}} src={"https://sanaa-production.up.railway.app/art_pieces/"+img.file} />
            <br /> <br />
